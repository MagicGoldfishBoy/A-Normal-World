...
module Hat
    class HatBase < Clothing::ClothingBase
        ...
        DEFAULT_EQUIP_SFX = SFX::EquipSFX::TEST_EQUIP_SFX
     ...
     def self.swap_hat(item)
        if item.as(Hat::HatBase).sfx
            ...
            puts "No sound effect for this hat."
        end
    ...
    class BaseballCap < HatBase
        @@white_baseball_cap = BaseballCap.new("White Baseball Cap", "W/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), 
        "white", true, DEFAULT_EQUIP_SFX)
        ...
        @@tan_baseball_cap = BaseballCap.new("Tan Baseball Cap", "T/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "tan", true, DEFAULT_EQUIP_SFX)
        ...
        @@brown_baseball_cap = BaseballCap.new("Brown Baseball Cap", "Br/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "brown", true, DEFAULT_EQUIP_SFX)
        ...
        @@red_baseball_cap = BaseballCap.new("Red Baseball Cap", "R/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "red", true, DEFAULT_EQUIP_SFX)
        ...
        @@orange_baseball_cap = BaseballCap.new("Orange Baseball Cap", "O/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "orange", true, DEFAULT_EQUIP_SFX)
        ...
        @@yellow_baseball_cap = BaseballCap.new("Yellow Baseball Cap", "Y/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "yellow", true, DEFAULT_EQUIP_SFX)
        ...
        @@yellow_green_baseball_cap = BaseballCap.new("Yellow-Green Baseball Cap", "Y-Gn/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "yellow-green", true, DEFAULT_EQUIP_SFX)
        ...
        @@green_baseball_cap = BaseballCap.new("Green Baseball Cap", "Gn/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "green", true, DEFAULT_EQUIP_SFX)
        ...
        @@turquoise_baseball_cap = BaseballCap.new("Turquoise Baseball Cap", "Tq/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "turquoise", true, DEFAULT_EQUIP_SFX)
        ...
        @@light_blue_baseball_cap = BaseballCap.new("Light Blue Baseball Cap", "L-Bl/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "light-blue", true, DEFAULT_EQUIP_SFX)
        ...
        @@blue_baseball_cap = BaseballCap.new("Blue Baseball Cap", "Bl/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "blue", true, DEFAULT_EQUIP_SFX)
        ...
        @@indigo_baseball_cap = BaseballCap.new("Indigo Baseball Cap", "In/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "indigo", true, DEFAULT_EQUIP_SFX)
        ...
        @@light_purple_baseball_cap = BaseballCap.new("Light Purple Baseball Cap", "L-Pr/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "light-purple", true, DEFAULT_EQUIP_SFX)
        ...
        @@purple_baseball_cap = BaseballCap.new("Purple Baseball Cap", "Pr/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "purple", true, DEFAULT_EQUIP_SFX)
        ...
        @@pink_baseball_cap = BaseballCap.new("Pink Baseball Cap", "Pk/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "pink", true, DEFAULT_EQUIP_SFX)
        ...
        @@hot_pink_baseball_cap = BaseballCap.new("Hot-Pink Baseball Cap", "H-Pk/Baseball Cap", true, SF::Sprite.new(WHITE_BASEBALL_CAP_TEXTURE), "hot-pink", true, DEFAULT_EQUIP_SFX)
    ...
    class Beanie < HatBase
        @@white_beanie = Beanie.new("White Beanie", "W/Beanie", true, SF::Sprite.new(BEANIE_TEXTURE), "white", true, DEFAULT_EQUIP_SFX)
        ...
        @@grey_beanie = Beanie.new("Grey Beanie", "Gy/Beanie", true, SF::Sprite.new(BEANIE_TEXTURE), "grey", true, DEFAULT_EQUIP_SFX)
        ...
        @@black_beanie = Beanie.new("Black Beanie", "Bk/Beanie", true, SF::Sprite.new(BEANIE_TEXTURE), "black", true, DEFAULT_EQUIP_SFX)
        ...
        @@tan_beanie = Beanie.new("Tan Beanie", "T/Beanie", true, SF::Sprite.new(BEANIE_TEXTURE), "tan", true, DEFAULT_EQUIP_SFX)
        ...
        @@brown_beanie = Beanie.new("Brown Beanie", "Br/Beanie", true, SF::Sprite.new(BEANIE_TEXTURE), "brown", true, DEFAULT_EQUIP_SFX)
        ...
        @@red_beanie = Beanie.new("Red Beanie", "R/Beanie", true, SF::Sprite.new(BEANIE_TEXTURE), "red", true, DEFAULT_EQUIP_SFX)
        ...
        @@orange_beanie = Beanie.new("Orange Beanie", "O/Beanie", true, SF::Sprite.new(BEANIE_TEXTURE), "orange", true, DEFAULT_EQUIP_SFX)
