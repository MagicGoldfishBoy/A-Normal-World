...
module LevelEditorGui
    class LevelEditorGuiElements
        ...
        CURRENT_ELEMENT_LEFT_ARROW = Ui_Elements::MenuBoxes.new("Selected Level Left Arrow", "LevEdMen6", 
        SF::Sprite.new(BLANK_TEXTURE, SF::Rect.new(900, 50, 50, 40)), 50.0, 40.0, 2)

        CURRENT_ELEMENT_RIGHT_ARROW = Ui_Elements::MenuBoxes.new("Selected Level Right Arrow", "LevEdMen7", 
        SF::Sprite.new(BLANK_TEXTURE, SF::Rect.new(950, 50, 50, 40)), 50.0, 40.0, 2)



        CURRENT_TEMPLATE_CATEGORY_BOX = Ui_Elements::MenuBoxes.new("Level Element Type Menu", "LevEdMen7", 
        SF::Sprite.new(BLANK_TEXTURE, SF::Rect.new(900, 0, 160, 40)), 160.0, 40.0, 1)
    ...
    class LevelEditorGuiDisplay
        def self.draw_level_editor_ui(window)
            if SF::Event::Resized
                ...
                LevelEditorGuiElements::CURRENT_ELEMENT_LEFT_ARROW.sprite.scale = SF.vector2(scale_x, scale_y)
                LevelEditorGuiElements::CURRENT_ELEMENT_LEFT_ARROW.sprite.position = LevelEditorGuiElements::CURRENT_ELEMENT_BOX.sprite.position - SF.vector2(50 * scale_x, 0)
    
                LevelEditorGuiElements::CURRENT_ELEMENT_RIGHT_ARROW.sprite.scale = SF.vector2(scale_x, scale_y)
                LevelEditorGuiElements::CURRENT_ELEMENT_RIGHT_ARROW.sprite.position = LevelEditorGuiElements::CURRENT_ELEMENT_BOX.sprite.position +
                SF.vector2(LevelEditorGuiElements::CURRENT_ELEMENT_BOX.sprite.global_bounds.width, 0)
    
    
                LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_BOX.sprite.scale = SF.vector2(scale_x, scale_y)
                LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_BOX.sprite.position = LevelEditorGuiElements::MAIN_LEVEL_EDITOR_BOX.sprite.position + SF.vector2(325 * scale_x, 55 * scale_y)
    
                LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_TEXT.text.scale = SF.vector2(scale_x, scale_y)
                LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_TEXT.text.position = LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_BOX.sprite.position + SF.vector2(75 * clamped_scale, 12 * scale_ratio)
                LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_TEXT.text.string = LevelEditor::LevelEditorLogic.current_element_type
                Utility::StringUtilities.center_text(LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_TEXT.text)
    
                LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_LEFT_ARROW.sprite.scale = SF.vector2(scale_x, scale_y)
                LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_LEFT_ARROW.sprite.position = LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_BOX.sprite.position - SF.vector2(50 * scale_x, 0)
    
                LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_RIGHT_ARROW.sprite.scale = SF.vector2(scale_x, scale_y)
                LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_RIGHT_ARROW.sprite.position = LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_BOX.sprite.position +
                SF.vector2(LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_BOX.sprite.global_bounds.width, 0)
            end
            ...
            window.draw(LevelEditorGuiElements::CURRENT_ELEMENT_LEFT_ARROW.sprite)
            window.draw(LevelEditorGuiElements::CURRENT_ELEMENT_RIGHT_ARROW.sprite)
    
            window.draw(LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_BOX.sprite)
            window.draw(LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_TEXT.text)
            window.draw(LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_LEFT_ARROW.sprite)
            window.draw(LevelEditorGuiElements::CURRENT_TEMPLATE_CATEGORY_RIGHT_ARROW.sprite)
