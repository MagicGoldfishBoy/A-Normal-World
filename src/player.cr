...
module Player
  ...
  class Appearance
    def initialize(skin : String, hair : String, face : String, hat : Hat::HatBase | Nil, glasses : Glasses::GlassesBase | Nil, 
        ...
        shoes : Shoes::ShoesBase | Nil, socks : String, makeup : Makeup::MakeupBase | Nil, necklace : Necklace::NecklaceBase | Nil, jacket : Jacket::JacketBase | Nil, weapon : String)
        @skin = skin
        @@skin = skin
        @hair = hair
        @@hair = hair
    ...
    class_property hat : Hat::HatBase | Nil = nil

    class_property glasses : Glasses::GlassesBase | Nil = nil

    class_property earrings : Earrings::EarringsBase | Nil = nil

    class_property shirt : Shirt::ShirtBase | Nil = nil

    class_property gloves : Gloves::GlovesBase | Nil = nil

    class_property pants : Pants::PantsBase | Nil = nil

    class_property shoes : Shoes::ShoesBase | Nil = nil

    class_property socks : String = "W/Socks"

    class_property makeup : Makeup::MakeupBase | Nil = nil

    class_property necklace : Necklace::NecklaceBase | Nil = nil
